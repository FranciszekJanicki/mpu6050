...
static mpu6050_err_t mpu6050_bus_init(mpu6050_t const* mpu6050)
{
    return mpu6050->interface.bus_init ? mpu6050->interface.bus_init(mpu6050->interface.bus_user)
                                       : MPU6050_ERR_NULL;
}

static mpu6050_err_t mpu6050_bus_deinit(mpu6050_t const* mpu6050)
{
    return mpu6050->interface.bus_deinit
               ? mpu6050->interface.bus_deinit(mpu6050->interface.bus_user)
               : MPU6050_ERR_NULL;
}

static mpu6050_err_t mpu6050_bus_write(mpu6050_t const* mpu6050,
                                       uint8_t address,
                                       uint8_t const* data,
                                       size_t data_size)
{
    return mpu6050->interface.bus_write
               ? mpu6050->interface.bus_write(mpu6050->interface.bus_user, address, data, data_size)
               : MPU6050_ERR_NULL;
}

static mpu6050_err_t mpu6050_bus_read(mpu6050_t const* mpu6050,
                                      uint8_t address,
                                      uint8_t* data,
                                      size_t data_size)
{
    return mpu6050->interface.bus_read
               ? mpu6050->interface.bus_read(mpu6050->interface.bus_user, address, data, data_size)
               : MPU6050_ERR_NULL;
}
                                 ...
                                 mpu6050_interface_t const* interface)
{
    ...
    return mpu6050_bus_init(mpu6050);
}
...
mpu6050_err_t mpu6050_deinitialize(mpu6050_t* mpu6050)
{
    ...
    mpu6050_err_t err = mpu6050_bus_deinit(mpu6050);
                                   ...
                                   uint8_t data_size)
{
    ...
    err |= mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_EXT_SENS_DATA_00, data, data_size);
                                    ...
                                    uint8_t data_size)
{
    ...
    err |= mpu6050_bus_write(mpu6050, slave_num, data, data_size);
...
mpu6050_err_t mpu6050_fifo_read(mpu6050_t const* mpu6050, uint8_t* data, uint8_t data_size)
{
    ...
    return mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_FIFO_R_W, data, data_size);
}
...
mpu6050_err_t mpu6050_fifo_write(mpu6050_t const* mpu6050, uint8_t const* data, uint8_t data_size)
{
    ...
    return mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_FIFO_R_W, data, data_size);
}
...
mpu6050_err_t mpu6050_get_xg_offs_tc_reg(mpu6050_t const* mpu6050, mpu6050_xg_offs_tc_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_XG_OFFS_TC, &data, sizeof(data));
                                         ...
                                         mpu6050_xg_offs_tc_reg_t const* reg)
{
    ...
    return mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_XG_OFFS_TC, &data, sizeof(data));
}
...
mpu6050_err_t mpu6050_get_yg_offs_tc_reg(mpu6050_t const* mpu6050, mpu6050_yg_offs_tc_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_YG_OFFS_TC, &data, sizeof(data));
                                         ...
                                         mpu6050_yg_offs_tc_reg_t const* reg)
{
    ...
    err |= mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_YG_OFFS_TC, &data, sizeof(data));
...
mpu6050_err_t mpu6050_get_zg_offs_tc_reg(mpu6050_t const* mpu6050, mpu6050_zg_offs_tc_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_ZG_OFFS_TC, &data, sizeof(data));
                                         ...
                                         mpu6050_zg_offs_tc_reg_t const* reg)
{
    ...
    err |= mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_ZG_OFFS_TC, &data, sizeof(data));
...
mpu6050_err_t mpu6050_get_x_fine_gain_reg(mpu6050_t const* mpu6050, mpu6050_x_fine_gain_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_X_FINE_GAIN, &data, sizeof(data));
                                          ...
                                          mpu6050_x_fine_gain_reg_t const* reg)
{
    ...
    return mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_X_FINE_GAIN, &data, sizeof(data));
}
...
mpu6050_err_t mpu6050_get_y_fine_gain_reg(mpu6050_t const* mpu6050, mpu6050_y_fine_gain_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_Y_FINE_GAIN, &data, sizeof(data));
                                          ...
                                          mpu6050_y_fine_gain_reg_t const* reg)
{
    ...
    return mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_Y_FINE_GAIN, &data, sizeof(data));
}
...
mpu6050_err_t mpu6050_get_z_fine_gain_reg(mpu6050_t const* mpu6050, mpu6050_z_fine_gain_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_Z_FINE_GAIN, &data, sizeof(data));
                                          ...
                                          mpu6050_z_fine_gain_reg_t const* reg)
{
    ...
    return mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_Z_FINE_GAIN, &data, sizeof(data));
}
...
mpu6050_err_t mpu6050_get_xa_offs_reg(mpu6050_t const* mpu6050, mpu6050_xa_offs_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_XA_OFFS_H, data, sizeof(data));
...
mpu6050_err_t mpu6050_set_xa_offs_reg(mpu6050_t const* mpu6050, mpu6050_xa_offs_reg_t const* reg)
{
    ...
    return mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_XA_OFFS_H, data, sizeof(data));
}
...
mpu6050_err_t mpu6050_get_ya_offs_reg(mpu6050_t const* mpu6050, mpu6050_ya_offs_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_YA_OFFS_H, data, sizeof(data));
...
mpu6050_err_t mpu6050_set_ya_offs_reg(mpu6050_t const* mpu6050, mpu6050_ya_offs_reg_t const* reg)
{
    ...
    return mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_YA_OFFS_H, data, sizeof(data));
}
...
mpu6050_err_t mpu6050_get_za_offs_reg(mpu6050_t const* mpu6050, mpu6050_za_offs_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_ZA_OFFS_H, data, sizeof(data));
...
mpu6050_err_t mpu6050_set_za_offs_reg(mpu6050_t const* mpu6050, mpu6050_za_offs_reg_t const* reg)
{
    ...
    return mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_ZA_OFFS_H, data, sizeof(data));
}
...
mpu6050_err_t mpu6050_get_self_test_x_reg(mpu6050_t const* mpu6050, mpu6050_self_test_x_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_SELF_TEST_X, &data, sizeof(data));
                                          ...
                                          mpu6050_self_test_x_reg_t const* reg)
{
    ...
    return mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_SELF_TEST_X, &data, sizeof(data));
}
...
mpu6050_err_t mpu6050_get_self_test_y_reg(mpu6050_t const* mpu6050, mpu6050_self_test_y_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_SELF_TEST_Y, &data, sizeof(data));
                                          ...
                                          mpu6050_self_test_y_reg_t const* reg)
{
    ...
    return mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_SELF_TEST_Y, &data, sizeof(data));
}
...
mpu6050_err_t mpu6050_get_self_test_z_reg(mpu6050_t const* mpu6050, mpu6050_self_test_z_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_SELF_TEST_Z, &data, sizeof(data));
                                          ...
                                          mpu6050_self_test_z_reg_t const* reg)
{
    ...
    return mpu6050_bus_write(mpu6050, MPU6050_REG_ADDRESS_SELF_TEST_Z, &data, sizeof(data));
}
...
mpu6050_err_t mpu6050_get_self_test_a_reg(mpu6050_t const* mpu6050, mpu6050_self_test_a_reg_t* reg)
{
    ...
    mpu6050_err_t err =
        mpu6050_bus_read(mpu6050, MPU6050_REG_ADDRESS_SELF_TEST_A, &data, sizeof(data));
